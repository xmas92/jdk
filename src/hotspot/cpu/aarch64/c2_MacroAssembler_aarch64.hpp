...
// C2_MacroAssembler contains high-level macros for C2
 ...
 private:
  Address adjust_compact_object_header_address_c2(Address addr, Register tmp);

 public:
  void load_nklass_compact_c2(Register dst, Address src);
  void store_compact_object_header_c2(Address dst, Register header);
  void encode_and_store_compact_object_header_c2(Address dst, Register nklass);
  void encode_and_store_compact_object_header_c2(Address dst, Klass* klass);
