...
public:
  ...
  void lightweight_lock(Register obj, Register hdr, Register t1, Register t2, Register box, Label& slow);
  void lightweight_unlock(Register obj, Register hdr, Register t1, Register t2, Register box, Label& slow);
