...
public:
 ...
 public:
  ...
  void lightweight_lock(Register obj, Register box, Register reg_rax, Register thread, Register tmp, Label& slow);
  void lightweight_unlock(Register obj, Register box, Register reg_rax, Register thread, Register tmp, Label& slow);
};
