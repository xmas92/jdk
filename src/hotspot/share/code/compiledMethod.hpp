...
public:
  ...
  int scopes_data_size() const {
    return narrow_cast<int>(scopes_data_end() - scopes_data_begin());
  }

  virtual PcDesc* scopes_pcs_begin() const = 0;
  virtual PcDesc* scopes_pcs_end() const = 0;
  int scopes_pcs_size() const {
    return narrow_cast<int>((intptr_t) scopes_pcs_end() - (intptr_t) scopes_pcs_begin());
    }
  ...
  int insts_size() const {
    return narrow_cast<int>(insts_end() - insts_begin());
  }
  ...
  int consts_size() const {
    return narrow_cast<int>(consts_end() - consts_begin());
  }
  ...
  int stub_size() const {
    return narrow_cast<int>(stub_end() - stub_begin());
  }
  ...
  int handler_table_size() const {
    return narrow_cast<int>(handler_table_end() - handler_table_begin());
  }
  ...
  int nul_chk_table_size() const {
    return  narrow_cast<int>(nul_chk_table_end() - nul_chk_table_begin());
  }
