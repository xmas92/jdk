...
void ZGlobalsPointers::initialize() {
  ...
  ZAddressMaxHeapRecommendedHeapBaseShift = MIN2(desired_heap_base_shift, ZAddressHeapBaseMaxShift);
  ZAddressInitialHeapBaseShift = ZForceHighestHeapBase
      ? ZAddressPlatformHeapBaseMaxShift
      : MAX2(ZAddressHeapBaseRecommendInitalMinShift, ZAddressMaxHeapRecommendedHeapBaseShift);
