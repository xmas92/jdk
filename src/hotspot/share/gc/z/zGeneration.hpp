...
public:
  ...
  void select_tenuring_threshold(ZRelocationSetSelectorLiveStats stats, bool promote_all);
  uint compute_tenuring_threshold(ZRelocationSetSelectorLiveStats stats);
