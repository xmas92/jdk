...
protected:
  explicit constexpr AtomicRefBase(volatile T& value) : _value_ptr(&value) {}
  ~AtomicRefBase() = default;
  constexpr AtomicRefBase(AtomicRefBase const&) = default;
  constexpr AtomicRefBase& operator=(AtomicRefBase const&) = default;
...
protected:
  explicit constexpr AtomicRefTranslatedBase(volatile Decayed& decayed_value) : _value(decayed_value) {}
  explicit constexpr AtomicRefTranslatedBase(volatile T& value) : AtomicRefTranslatedBase(*reinterpret_cast<volatile Decayed*>(&value)) {
    STATIC_ASSERT(sizeof(T) == sizeof(Decayed));
  }
  ~AtomicRefTranslatedBase() = default;
  constexpr AtomicRefTranslatedBase(AtomicRefTranslatedBase const&) = default;
  constexpr AtomicRefTranslatedBase& operator=(AtomicRefTranslatedBase const&) = default;
...
public:
  ...
  explicit constexpr Atomic(T value) : SupportsBitOperations<T, AtomicImpl::AtomicBase<T>>(value) {}
  ~Atomic() = default;
  NONCOPYABLE(Atomic);
...
public:
  explicit constexpr  AtomicRef(volatile T& value) : SupportsBitOperations<T, AtomicImpl::AtomicRefBase<T>>(value) {}
  ~AtomicRef() = default;
  constexpr AtomicRef(AtomicRef const&) = default;
  constexpr AtomicRef& operator=(AtomicRef const&) = default;
...
public:
  constexpr Atomic() : Atomic(0) {}
  explicit constexpr Atomic(T value) : CommonCore<T, AtomicImpl::AtomicBase<T>>(value) {}
  ~Atomic() = default;
  NONCOPYABLE(Atomic);
...
public:
  explicit constexpr AtomicRef(volatile T& value) : CommonCore<T, AtomicImpl::AtomicRefBase<T>>(value) {}
  ~AtomicRef() = default;
  constexpr AtomicRef(AtomicRef const&) = default;
  constexpr AtomicRef& operator=(AtomicRef const&) = default;
...
public:
  ...
  explicit constexpr Atomic(T value) : SupportsArithmetic<T, AtomicImpl::AtomicBase<T>>(value) {}
  ~Atomic() = default;
  NONCOPYABLE(Atomic);
...
public:
  constexpr Atomic() : CommonCoreTranslated<T, AtomicImpl::AtomicTranslatedBase<T>>() {}
  explicit constexpr Atomic(T value) : CommonCoreTranslated<T, AtomicImpl::AtomicTranslatedBase<T>>(value) {}
  ~Atomic() = default;
  NONCOPYABLE(Atomic);
...
public:
  explicit constexpr AtomicRef(volatile typename AtomicImpl::AtomicRefTranslatedBase<T>::Decayed& decayed_value)
    : CommonCoreTranslated<T, AtomicImpl::AtomicRefTranslatedBase<T>>(decayed_value) {}
  explicit constexpr AtomicRef(volatile T& value) : CommonCoreTranslated<T, AtomicImpl::AtomicRefTranslatedBase<T>>(value) {}
  ~AtomicRef() = default;
  constexpr AtomicRef(AtomicRef const&) = default;
  constexpr AtomicRef& operator=(AtomicRef const&) = default;
