...
static bool check_stack_headroom(address stack_bottom,
...
void VMError::reenterant_test_hit_stack_limit() {
  static const address stack_top    = _thread != nullptr
                                    ? _thread->stack_base()
                                    : os::current_stack_base();
  static const size_t  stack_size   = _thread != nullptr
                                    ? _thread->stack_size()
  ...
  const ptrdiff_t stack_headroom = stack_pointer - stack_bottom;
  if (!check_stack_headroom(stack_bottom, stack_pointer,
                           _reentrant_reentries_stack_headroom)) {
