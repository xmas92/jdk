...
TEST_VM(AtomicEnumTest, unscoped_enum) {
  ...
  using Support = AtomicTestSupport<TestEnum>;
...
TEST_VM(AtomicEnumTest, scoped_enum) {
  ...
  using Support = AtomicTestSupport<AtomicEnumTestScoped>;
...
TEST_VM(AtomicEnumTest, scoped_enum_64_bit) {
  ...
  using Support = AtomicTestSupport<AtomicEnumTestScoped64Bit>;
...
TEST_VM(AtomicEnumTest, scoped_enum_8_bit) {
  ...
  using Support = AtomicTestSupport<AtomicEnumTestScoped8Bit>;
...
TEST_VM(AtomicByteTest, char_test) {
  const char B = 0xB;
  const char C = 0xC;
  using Support = AtomicTestSupport<char>;
...
TEST_VM(AtomicByteTest, bool_test) {
  const bool B = true;
  const bool C = false;
  using Support = AtomicTestSupport<bool>;
