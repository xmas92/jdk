 ...
 * @requires !vm.opt.final.UseLargePages & !vm.opt.final.UseTransparentHugePages
...
public class TestAllocateHeapAt {
    public static void main(String[] args) throws Exception {
        ...
        if (mode != ShmemTHPMode.never && mode != ShmemTHPMode.advise) {
            throw new SkippedException("The UseTransparentHugepages may not respected with Shmem THP Mode: " + mode.name());
        }
