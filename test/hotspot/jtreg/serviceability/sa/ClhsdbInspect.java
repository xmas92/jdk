...
public class ClhsdbInspect {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            // ...
            // WeakHandle Klass::_java_mirror: WeakHandle @ 0x000000080000f400
            // ...
            //
            ...
            cmds = List.of(cmd);
            expStrMap = new HashMap<>();
            expStrMap.put(cmd, List.of("Type is InstanceKlass", "Klass::_java_mirror: WeakHandle @"));
            ...
            String mirrorPattern = "Klass::_java_mirror: WeakHandle @ ";
